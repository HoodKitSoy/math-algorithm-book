...
#
# 各言語で実装された「007-Number_of_Multiples_1」のコードをテストし、実行速度を計測するスクリプト
#
...
# テストケース (入力 => 期待される出力)
# 3つの整数入力（N X Y、出力はN以下でXまたはYの倍数の個数）
declare -A TEST_CASES

# テストケース1: 問題例1 (15 3 5 => 7)
TEST_CASES["case1_input"]="15 3 5"
TEST_CASES["case1_expected"]="7"

# テストケース2: 問題例2 (1000000 11 13 => 160839)
TEST_CASES["case2_input"]="1000000 11 13"
TEST_CASES["case2_expected"]="160839"

# テストケース3: 小さな値のテスト (10 2 3 => 7) [2,3,4,6,8,9,10]
TEST_CASES["case3_input"]="10 2 3"
TEST_CASES["case3_expected"]="7"
...
print_header "Running tests for 007-Number_of_Multiples_1"
