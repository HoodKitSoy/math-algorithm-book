...
#
# 各言語で実装された「010-Factorial」のコードをテストし、実行速度を計測するスクリプト
#
...
TEST_CASES["case1_expected"]="120"

# テストケース2: 最小値テスト (1 => 1)
TEST_CASES["case2_input"]="1"
TEST_CASES["case2_expected"]="1"

# テストケース3: 小さな値テスト (3 => 6)
TEST_CASES["case3_input"]="3"
TEST_CASES["case3_expected"]="6"

# テストケース4: 中間値テスト (10 => 3628800)
TEST_CASES["case4_input"]="10"
TEST_CASES["case4_expected"]="3628800"

# テストケース5: 最大値テスト (20 => 2432902008176640000)
TEST_CASES["case5_input"]="20"
TEST_CASES["case5_expected"]="2432902008176640000"
...
print_header "Running tests for 010-Factorial"
