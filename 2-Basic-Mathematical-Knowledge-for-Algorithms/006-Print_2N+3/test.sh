...
#
# 各言語で実装された「006-Print_2N+3」のコードをテストし、実行速度を計測するスクリプト
#
...
# テストケース1: 例1 (N=100 => 2×100+3=203)
TEST_CASES["case1_input"]="100"
TEST_CASES["case1_expected"]="203"

# テストケース2: 例2 (N=27 => 2×27+3=57)
TEST_CASES["case2_input"]="27"
TEST_CASES["case2_expected"]="57"

# テストケース3: 最小値テスト (N=1 => 2×1+3=5)
TEST_CASES["case3_input"]="1"
TEST_CASES["case3_expected"]="5"

# テストケース4: 中間値テスト (N=50 => 2×50+3=103)
TEST_CASES["case4_input"]="50"
TEST_CASES["case4_expected"]="103"

# テストケース5: 任意値テスト (N=42 => 2×42+3=87)
TEST_CASES["case5_input"]="42"
TEST_CASES["case5_expected"]="87"
...
print_header "Running tests for 006-Print_2N+3"
